...
>[!NOTE]
>
>All the users now have **[!UICONTROL Fast Download]** enabled by default and requires IBM&reg; [Aspera Connect 3.9.9](https://www.ibm.com/support/fixcentral/swg/selectFixes?parent=ibm%7EOther%20software&product=ibm/Other+software/IBM+Aspera+Connect&release=3.9.9&platform=All&function=all_) installed in their browser's extension before downloading the assets from Brand Portal.
